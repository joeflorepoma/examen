...
int main()
{
    ...
    alquiler_ingresoDatos(alquileres, 3, 4, 33, 3, 11, 10, 1998);
    alquiler_ingresoDatos(alquileres, 4, 5, 33, 5, 11, 10, 1998);
    alquiler_ingresoDatos(alquileres, 5, 6, 33, 4, 11, 10, 1998);
    alquiler_ingresoDatos(alquileres, 6, 7, 33, 4, 11, 10, 1998);
    alquiler_ingresoDatos(alquileres, 7, 8, 22, 3, 11, 10, 1998);
    alquiler_ingresoDatos(alquileres, 8, 9, 44, 2, 11, 10, 1998);
    alquiler_ingresoDatos(alquileres, 9, 10, 44, 2, 11, 10, 1998);
